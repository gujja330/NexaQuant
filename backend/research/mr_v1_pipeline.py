...
STAGES = [
    ...
    (23, "STAGE_23_experiment_consolidator", "mr_experiment_consolidator",
     "CEO close-out · 5 experiments → 3 focused (X1/X2/X3) + supersede/archive"),
    (24, "STAGE_24_experiment_runner", "mr_experiment_runner",
     "Shadow experiment runner · apply 3 focused (+5 archived) rules today (no prod)"),
    (25, "STAGE_25_fundamentals_gap", "mr_fundamentals_gap_check",
     "Fundamentals coverage gap check + closure plan"),
    (26, "STAGE_26_daily_control_panel", "mr_daily_control_panel",
     "Daily research control panel · Today / 30D / Forward / Verdict"),
    (27, "STAGE_27_evidence_report", "mr_evidence_report",
     "CEO compact daily evidence report · one row per focused experiment"),
    (28, "STAGE_28_promotion_trigger", "mr_promotion_trigger",
     "Auto-fire promotion evaluation when any experiment reaches N >= 100"),
    (29, "STAGE_29_evidence_layer", "mr_evidence_layer",
     "Evidence Layer · History + Portfolio + Exit JSONLs per market (append-only)"),
    (30, "STAGE_30_research_archive", "mr_research_archive",
     "Research Archive · successful/promising/failed/superseded/data_gaps/retired"),
    (31, "STAGE_31_learning_report", "mr_learning_report",
     "Learning Report · what AEGIS actually learned in 45 days"),
    (32, "STAGE_32_experiment_outcomes", "mr_experiment_outcomes",
     "Per-experiment outcomes ledger · append fwd 1/3/5/10/20d + WIN/LOSS + MFE/MAE"),
    (33, "STAGE_33_archive_index", "mr_archive_index",
     "Archive Index · 5-way status per finding (success/promise/fail/superseded/data-gap)"),
    (34, "STAGE_34_research_topology", "mr_research_topology",
     "Research Topology · CEO-spec tree + 6-field cards + historical/45d anchor"),
]
