...
DEFINITIONS_ROWS = [
    ...
    ("", ""),
    ("── Portfolio sheet (scope: CURRENT) ──", ""),
    ("Population",
     "Positions currently ACTIVE or SUGGESTED · excludes SHADOW · MOMENTUM · EXIT · rotation-artifact rows"),
    ("Active count",
    ...
    ("", ""),
    ("── Exit History (90d) sheet (scope: REALIZED 90d) ──", ""),
    ("Population",
     "Closed trades whose exit_date is within the last 90 calendar days · rotation artifacts (|pnl| ≤ 0.01%) excluded from summary"),
    ("Total exits",
