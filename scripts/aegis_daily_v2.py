...
STEPS = [
    ...
    {
        "name": "multi_layer_stress_regime",
        "desc": "Multi-layer research · stress-regime (reuses mr_market_regime · per-regime R2 P&L)",
        "script": "backend/research/multi_layer/stress_regime.py",
        "script_args": ["--market", "both"],
        "produces": [],
        "requires": [],
        "optional": True,
    ...
    {
        "name": "multi_layer_crash_resilience",
        "desc": "Multi-layer research · 5-state crash-resilience classifier",
        "script": "backend/research/multi_layer/crash_resilience.py",
        "script_args": ["--market", "both"],
        "produces": [],
        "requires": [],
        "optional": True,
    ...
    {
        "name": "multi_layer_runner_india",
        "desc": "Multi-layer research · India evidence (8 candidate layers · UNAVAILABLE contract)",
        "script": "backend/research/multi_layer/runner.py",
        "script_args": ["--market", "india"],
        "produces": [],
        "requires": [],
        "optional": True,
    ...
    {
        "name": "multi_layer_runner_usa",
        "desc": "Multi-layer research · USA evidence",
        "script": "backend/research/multi_layer/runner.py",
    ...
    {
        "name": "multi_layer_forward_outcomes",
        "desc": "Update momentum snapshots at t+1/3/5/10/20d forward outcomes",
        "script": "backend/research/multi_layer/momentum_forward_outcomes.py",
        "script_args": ["--market", "both"],
        "produces": [],
        "requires": [],
        "optional": True,
    },
    {
        ...
        # enforce). Does NOT modify the engine · just invokes existing
        # compute+emit for the market that was missing.
        "name": "dynamic_risk_v2_both_markets",
        "desc": "Invoke existing dynamic_risk_v2.compute for India + USA (produces per-position ATR/vol-scaled/trailing stops)",
        "script": "scripts/run_dynamic_risk_v2.py",
        "script_args": ["--market", "both"],
        "produces": ["reports/context/dynamic_risk_india.json",
                       "reports/context/dynamic_risk_usa.json"],
        "requires": [],
        "optional": True,
    },
    {
        "name": "dynamic_exit_bridge",
        "desc": ("Wires dynamic_risk_v2 + evaluate_position into Registry · "
                    "ENFORCE mode with authoritative-only rule (fires oreg.close ONLY "
                    "when stop_source is dynamic_risk_v2:*  ·  never enforces on static "
                    "or 6% fallback · preserves CEO 'no hardcoded stop' invariant)"),
        "script": "scripts/apply_dynamic_exits.py",
        "script_args": ["--market", "both", "--enforce"],
        "produces": [],
        "requires": ["reports/context/dynamic_risk_india.json"],
        "optional": True,
    },
    {
        "name": "aegis_r1_producer_audit",
        "desc": "R1 producer-wide retirement audit · 6 producers × 2 markets",
        "script": "scripts/r1_producer_audit.py",
        "script_args": ["--market", "both"],
        "produces": [],
        "requires": [],
        "optional": True,
    ...
    {
        "name": "aegis_overlap_classifier",
        "desc": "Portfolio↔Exit overlap 5-way classification",
        "script": "scripts/portfolio_exit_overlap_classifier.py",
        "script_args": ["--market", "both"],
        "produces": [],
        "requires": [],
        "optional": True,
    ...
    {
        "name": "aegis_final_reconciler",
        "desc": "21-check final reconciler for both markets (C1..C19)",
        "script": "scripts/aegis_final_reconciler.py",
        "script_args": ["--market", "both"],
        "produces": [],
        "requires": [],
        "optional": True,
    ...
    {
        "name": "aegis_local_certification",
        "desc": "50-gate local certification runner · LOCK_CANDIDATE verdict",
        "script": "scripts/aegis_local_certification.py",
        "produces": [],
        "requires": [],
        "optional": True,
    },
