# MON001 · Operator Dashboard — 2026-09-08
_Auto-generated 2026-09-08T11:14:57+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 54
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 72
- **Latest forward recommendation asof**: `2026-09-08`
- **Latest monitoring run**: `2026-09-08`
## Ledger health
- **Rows ingested**: 705
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 0.2989 | `PASS` | 54 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 54 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 54 | 126 |
