# MON001 · Operator Dashboard — 2026-08-25
_Auto-generated 2026-08-25T12:01:03+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 44
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 82
- **Latest forward recommendation asof**: `2026-08-25`
- **Latest monitoring run**: `2026-08-25`
## Ledger health
- **Rows ingested**: 570
...
|---|---:|:-:|---:|---:|
| sharpe_forward | -0.3874 | `PASS` | 44 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 44 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 44 | 126 |
