# MON001 · Operator Dashboard — 2026-07-31
_Auto-generated 2026-07-31T12:56:45+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 27
- **Days until first Sharpe reading (T30)**: 3
- **Days until first MaxDD reading (T126)**: 99
- **Latest forward recommendation asof**: `2026-07-31`
- **Latest monitoring run**: `2026-07-31`
## Ledger health
- **Rows ingested**: 345
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 27 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 27 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 27 | 126 |
