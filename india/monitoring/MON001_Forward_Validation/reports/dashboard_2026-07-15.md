...
_Auto-generated 2026-07-15T09:39:58+00:00_
## Summary
- **State**: `DIVERGED`
- **HALT_REVIEW_REQUIRED**: `False`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 15
- **Days until first Sharpe reading (T30)**: 15
- **Days until first MaxDD reading (T126)**: 111
- **Latest forward recommendation asof**: `2026-07-14`
- **Latest monitoring run**: `2026-07-15`
## Ledger health
- **Rows ingested**: 150
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 15 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 15 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 15 | 126 |
