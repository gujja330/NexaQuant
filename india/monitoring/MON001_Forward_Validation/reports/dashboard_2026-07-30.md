# MON001 · Operator Dashboard — 2026-07-30
_Auto-generated 2026-07-30T12:28:58+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 26
- **Days until first Sharpe reading (T30)**: 4
- **Days until first MaxDD reading (T126)**: 100
- **Latest forward recommendation asof**: `2026-07-30`
- **Latest monitoring run**: `2026-07-30`
## Ledger health
- **Rows ingested**: 330
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 26 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 26 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 26 | 126 |
