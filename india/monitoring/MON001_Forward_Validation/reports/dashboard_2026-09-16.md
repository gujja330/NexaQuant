# MON001 · Operator Dashboard — 2026-09-16
_Auto-generated 2026-09-16T11:14:54+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 60
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 66
- **Latest forward recommendation asof**: `2026-09-16`
- **Latest monitoring run**: `2026-09-16`
## Ledger health
- **Rows ingested**: 780
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 1.3842 | `PASS` | 60 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 60 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 60 | 126 |
