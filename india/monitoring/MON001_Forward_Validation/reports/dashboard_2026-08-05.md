# MON001 · Operator Dashboard — 2026-08-05
_Auto-generated 2026-08-05T12:53:13+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 30
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 96
- **Latest forward recommendation asof**: `2026-08-05`
- **Latest monitoring run**: `2026-08-05`
## Ledger health
- **Rows ingested**: 390
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 2.5323 | `PASS` | 30 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 30 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 30 | 126 |
