# MON001 · Operator Dashboard — 2026-07-20
_Auto-generated 2026-07-20T13:07:08+00:00_
## Summary
- **State**: `DIVERGED`
- **HALT_REVIEW_REQUIRED**: `False`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 18
- **Days until first Sharpe reading (T30)**: 12
- **Days until first MaxDD reading (T126)**: 108
- **Latest forward recommendation asof**: `2026-07-20`
- **Latest monitoring run**: `2026-07-20`
## Ledger health
- **Rows ingested**: 255
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 18 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 18 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 18 | 126 |
