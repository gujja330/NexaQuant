...
- **Days until first MaxDD reading (T126)**: 63
- **Latest forward recommendation asof**: `2026-09-21`
- **Latest monitoring run**: `2026-09-21`
## Ledger health
- **Rows ingested**: 808
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 0.0607 | `PASS` | 63 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 63 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 63 | 126 |
