# MON001 · Operator Dashboard — 2026-09-07
_Auto-generated 2026-09-07T11:14:55+00:00_
## Summary
- **State**: `DIVERGED`
- **HALT_REVIEW_REQUIRED**: `False`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 52
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 74
- **Latest forward recommendation asof**: `2026-09-04`
- **Latest monitoring run**: `2026-09-07`
## Ledger health
- **Rows ingested**: 675
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 0.1350 | `PASS` | 52 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 52 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 52 | 126 |
