# MON001 · Operator Dashboard — 2026-09-04
_Auto-generated 2026-09-04T11:13:26+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 51
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 75
- **Latest forward recommendation asof**: `2026-09-03`
- **Latest monitoring run**: `2026-09-04`
## Ledger health
- **Rows ingested**: 660
...
|---|---:|:-:|---:|---:|
| sharpe_forward | -0.1381 | `PASS` | 51 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 51 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 51 | 126 |
