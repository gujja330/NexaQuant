# MON001 · Operator Dashboard — 2026-09-25
_Auto-generated 2026-09-25T19:35:02+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 67
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 59
- **Latest forward recommendation asof**: `2026-09-25`
- **Latest monitoring run**: `2026-09-25`
## Ledger health
- **Rows ingested**: 864
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 1.2631 | `PASS` | 67 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 67 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 67 | 126 |
