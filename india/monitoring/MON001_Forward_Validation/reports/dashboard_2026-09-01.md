# MON001 · Operator Dashboard — 2026-09-01
_Auto-generated 2026-09-01T11:13:25+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 48
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 78
- **Latest forward recommendation asof**: `2026-08-31`
- **Latest monitoring run**: `2026-09-01`
## Ledger health
- **Rows ingested**: 615
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 0.0636 | `PASS` | 48 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 48 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 48 | 126 |
