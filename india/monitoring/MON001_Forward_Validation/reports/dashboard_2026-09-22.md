# MON001 · Operator Dashboard — 2026-09-22
_Auto-generated 2026-09-22T19:15:16+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 64
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 62
- **Latest forward recommendation asof**: `2026-09-22`
- **Latest monitoring run**: `2026-09-22`
## Ledger health
- **Rows ingested**: 822
...
|---|---:|:-:|---:|---:|
| sharpe_forward | 0.7943 | `PASS` | 64 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 64 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 64 | 126 |
