# MON001 · Operator Dashboard — 2026-07-29
_Auto-generated 2026-07-29T13:01:22+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 25
- **Days until first Sharpe reading (T30)**: 5
- **Days until first MaxDD reading (T126)**: 101
- **Latest forward recommendation asof**: `2026-07-29`
- **Latest monitoring run**: `2026-07-29`
## Ledger health
- **Rows ingested**: 315
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 25 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 25 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 25 | 126 |
