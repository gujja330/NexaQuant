# MON001 · Operator Dashboard — 2026-08-21
_Auto-generated 2026-08-21T11:58:34+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 41
- **Days until first Sharpe reading (T30)**: 0
- **Days until first MaxDD reading (T126)**: 85
- **Latest forward recommendation asof**: `2026-08-20`
- **Latest monitoring run**: `2026-08-21`
## Ledger health
- **Rows ingested**: 540
...
|---|---:|:-:|---:|---:|
| sharpe_forward | -1.2017 | `PASS` | 41 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 41 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 41 | 126 |
