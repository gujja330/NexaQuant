# MON001 · Operator Dashboard — 2026-08-04
_Auto-generated 2026-08-04T13:03:07+00:00_
## Summary
- **State**: `HALT_REVIEW_REQUIRED`
- **HALT_REVIEW_REQUIRED**: `True`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 29
- **Days until first Sharpe reading (T30)**: 1
- **Days until first MaxDD reading (T126)**: 97
- **Latest forward recommendation asof**: `2026-08-04`
- **Latest monitoring run**: `2026-08-04`
## Ledger health
- **Rows ingested**: 375
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 29 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 29 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 29 | 126 |
