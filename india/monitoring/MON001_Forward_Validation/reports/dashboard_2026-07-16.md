# MON001 · Operator Dashboard — 2026-07-16
_Auto-generated 2026-07-16T12:21:00+00:00_
## Summary
- **State**: `DIVERGED`
- **HALT_REVIEW_REQUIRED**: `False`
- **Forward boundary**: `2026-03-28`
- **Forward trading days accumulated**: 16
- **Days until first Sharpe reading (T30)**: 14
- **Days until first MaxDD reading (T126)**: 110
- **Latest forward recommendation asof**: `2026-07-14`
- **Latest monitoring run**: `2026-07-16`
## Ledger health
- **Rows ingested**: 150
...
- **Status**: `OK`
- **Sealed hash**: `64e74483d9bd0444...`
- **Current hash**: `64e74483d9bd0444...`
## Broker status
- **Available**: `False`
...
|---|---:|:-:|---:|---:|
| sharpe_forward | — | `INSUFFICIENT_EVIDENCE` | 16 | 30 |
| max_dd_forward | — | `INSUFFICIENT_EVIDENCE` | 16 | 126 |
| ulcer_forward | — | `INSUFFICIENT_EVIDENCE` | 16 | 126 |
