...
def main():
    ...
    L = ["# Program X — Market Comparison & Decision (MARKET_DECISION.md)",
         ...
         "The earlier draft froze a USA-research / India-production split. That is **premature**: with ~17 "
         "experiments (mostly rejections) and neither market's R&D close to complete, choosing a market now "
         "would be preference, not evidence. The role-split above is a **hypothesis to test**, not a "
         "commitment. **Only one thing is locked now — the market-AGNOSTIC core** (the `MarketAdapter` seam), "
         "because that is architecture, not a market bet, and the one validated edge (regime overlay) is "
         "already cross-market.",
         "",
         "**The capital-allocation / product decision is postponed until BOTH research libraries are complete "
         "and portfolio simulations have run.** Phased plan:",
         "1. **Complete India R&D** — every domain through the gate (price/trend/momentum/vol/regime/quality/"
         "value/growth/seasonality/volume/breadth/insider/macro/ETF/news/ML/ensemble/risk). Goal: no major "
         "area left unexplored. (tracker: `DOMAIN_COVERAGE.md`)",
         ...
         "4. **Portfolio simulation** — India-only / USA-only / 50-50 / 70-30 / dynamic-allocation, identical "
         "assumptions, long history.",
         "5. **Capital-allocation & product decision** — where *our money* goes and what AEGIS *recommends* — "
         "from the completed evidence, not a predefined preference.",
         "",
         "_Pending: RC005 (insider) deep ingest still running. Next per plan: finish RC005 → complete India "
         "R&D → complete USA R&D → freeze libraries → portfolio sims → final decision._"]
