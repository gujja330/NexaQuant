# AEGIS Final Certification · Section 18 · 2026-09-02
...
| Gate | Status | Detail |
|------|--------|--------|
| G01_full_test_suite | PASS | 560 passed · 0 failed · 11 skipped |
| G02_e2e_build_india | PASS | xlsx.asof=2026-09-02 · dated=True |
| G03_e2e_build_usa | PASS | xlsx.asof=2026-09-02 · dated=True |
| G04_canonical_identity_india | PASS | 68 new-format PIDs · 0 legacy (source: Registry) |
| G05_registry_canonical_recon_india | PASS | Registry india: 25 ACTIVE · 43 CLOSED-90d |
...
| G08_exit_history_recon_india | PASS | 0 ACTIVE-runner non-carveout non-admin Registry-CLOSED missing from EH · 5 retired-runner · 0 carveout · 18 admin (same- |
...
| G18_three_run_determinism_india | PASS | 3-run data-only hash: 48621f09 / 48621f09 / 48621f09 |
...
| G04_canonical_identity_usa | PASS | 556 new-format PIDs · 0 legacy (source: Registry) |
| G05_registry_canonical_recon_usa | PASS | Registry usa: 23 ACTIVE · 533 CLOSED-90d |
...
| G08_exit_history_recon_usa | PASS | 0 ACTIVE-runner non-carveout non-admin Registry-CLOSED missing from EH · 11 retired-runner · 3 carveout · 20 admin (same |
...
| G10_runner_counts_usa | PASS | R1(RETIRED_DORMANT·opened=43·active=17) · R2(ACTIVE_PRODUCTION·opened=513·active=6) · COMBINED(ACTIVE_PRODUCTION·opened= |
| G11_r1_production_absence_usa | PASS | 0 retired-runner rows in Portfolio · retired=['R1'] |
| G12_r2_integrity_usa | PASS | status=ACTIVE_PRODUCTION · signals=513 · opened=513 · closed=507 |
...
| G18_three_run_determinism_usa | PASS | 3-run data-only hash: c8afadf9 / c8afadf9 / c8afadf9 |
...
| G21_locked_layer_diff | PASS | 0 diffs vs 0e3735a8 |
...
| G26_stress_regime_india | PASS | n_trades=20 · overall_mean_pnl_pct=-0.802 · regimes=['UNKNOWN', 'BEAR', 'BULL'] |
| G27_momentum_conservation_india | PASS | conservation_ok=True · silent_disappearances=0 · universe=2 · by_state={'ACCEPTED': 0, 'WATCH': 0, 'REJECTED': 2, 'NO_EV |
| G28_crash_resilience_india | PASS | today_regime=WEAKENING · n_r2_trades_tagged=0 · n_days_classified=1535 |
...
| G26_stress_regime_usa | PASS | n_trades=479 · overall_mean_pnl_pct=0.218 · regimes=['UNKNOWN'] |
...
| G28_crash_resilience_usa | PASS | today_regime=NORMAL · n_r2_trades_tagged=0 · n_days_classified=1254 |