...
- **Total recommendations:** 208  ·  **Held:** 0
- **Strong-Buy:** 7  ·  **Buy:** 44  ·  **Accumulate:** 0  ·  **Hold:** 0  ·  **Reduce:** 0  ·  **Sell:** 0

## Alpha vs NIFTY  🔵 Backtester

- **AEGIS avg return:** +2.00%  ·  **NIFTY:** +0.69%
...
_No material changes overnight — recommendation set is stable._

## Risk Alerts

- **PORTFOLIO_WARNING** · `PORTFOLIO` — vol 19.26% · 10 budget alerts

## Subsystem Attribution  🔵 Backtester

- **Alpha Creator:** `research` · α +3.73% · lift 1.06 · WR high 62.03% vs low 55.82%
- **Alpha Destroyer:** `rs_nifty` · α -6.52% · lift 0.89 · WR high 51.79% vs low 55.95%

## Archive Maturation

- **2 / 30** archive days accumulated
- **28** trading days until Alpha Signature v2.1 gate unlocks
