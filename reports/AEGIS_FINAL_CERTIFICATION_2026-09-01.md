...
| G04_canonical_identity_india | PASS | 313 new-format PIDs · 0 legacy |
...
| G13_pnl_reconciliation_india | PASS | 0 UNEXPLAINED dupes (bit-identical) · 0 EXPLAINED dupes (multi-observation same-day) |
| G14_provenance_validation_india | PASS | 46/46 opened rows have Position ID (100.0%) |
| G09_population_counts_india | PASS | HISTORICAL_CLOSED=37 · CURRENT_HOLDING=9 · FRESH_RECOMMENDATION=4 |
...
| G18_three_run_determinism_india | PASS | 3-run data-only hash: 656bb0f7 / 656bb0f7 / 656bb0f7 |
...
| G04_canonical_identity_usa | PASS | 17 new-format PIDs · 0 legacy |
...
| G18_three_run_determinism_usa | PASS | 3-run data-only hash: ffcc0a64 / ffcc0a64 / ffcc0a64 |
